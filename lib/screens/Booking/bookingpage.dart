      ...
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          ...
          _buildTicket(screenHeight, widget._dateRange, widget._destination,
              context, flightListOutbound, flightListInbound),
        ],
      ),
  ...
  return Dialog(
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Confirm flight and hotel selection',
            style: TextStyle(
                fontWeight: FontWeight.w600,
                fontFamily: 'Pangram',
                color: AppColors.kPrimaryColor,
          ...
          Text(
              'Note: You can change your flights and hotels 24 hours before your trip.'),
          SizedBox(
            height: 32,
          ),
          Row(
            ...
            children: [
              ...
              TextButton(
                  onPressed: () async {}, child: Text('Proceed to payment')),
            ],
          )
        ],
      ),
