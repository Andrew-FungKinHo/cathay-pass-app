...
class FlightSelection extends StatefulWidget {
  ...
  FlightSelection({DateTimeRange dateRange, String destination, bool outbound})
...
class _FlightSelectionState extends State<FlightSelection> {
  ...
  Widget build(BuildContext context) {
    ...
    List<FlightInfo> flightList =
        generateFlightInfo('Seoul', DateTime.now(), widget._outbound);
    return Scaffold(
        appBar: CustomAppBar(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: selectionProvider.getSelected(
                                        flightList, index)
                        ...
                        child: Column(
                          children: [
                                      ...
                                      children: <Widget>[
                                        ...
                                        Center(
                                          ...
                                          child: Icon(
                                            Icons.local_airport,
                                            color:
                                                AppColors.premiumEconClassColor,
                                            size: 24,
                                          ),
                                        ))
                                      ],
                            ...
                            selectionProvider.getSelected(flightList, index)
                                ? Align(
                                ...
                                : Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextButton(
                                        onPressed: () {
                                          selectionProvider
                                              .changeFlightSelection(flightList,
                                                  index, widget._outbound);
                                          print(selectionProvider.getSelected(
                                              flightList, index));
                                        },
                                        child: Text(
                                          'Select',
