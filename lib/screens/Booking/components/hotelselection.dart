...
class HotelSelection extends StatefulWidget {
  ...
  String _destination;
  HotelSelection({DateTimeRange dateRange, String destination})
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                          '${dateFormatFullEn.format(widget._dateRange.start)} - ${dateFormatFullEn.format((widget._dateRange.end))}'),
                    ],
                  ),
                ],
              ),
              ...
              Expanded(
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: selectionProvider.getSelectedHotel(
                                  hotelList, index)
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '${widget._dateRange.end.day - widget._dateRange.start.day} nights'),
                        ],
                      ),
                      SizedBox(
                        height: 8,
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          selectionProvider.getSelectedHotel(hotelList, index)
                              ? Align(
                              ...
                              : Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        selectionProvider.changeHotelSelection(
                                            hotelList, index);
                                        print(
                                            selectionProvider.getSelectedHotel(
                                                hotelList, index));
